...
int cpuvoltage[FREQCOUNT] = {1180,1000,950,900,850,800,750};
int cpuuvoffset[FREQCOUNT] = { 0, 0, 0, 0, 0, 0, 0};
/*
int cpufrequency[FREQCOUNT] = {192,456,608,816,912,1000,1200};
int cpuvoltage[FREQCOUNT] = {750,800,850,900,950,1000,1200};
int cpuuvoffset[FREQCOUNT] = { 0, 0, 0, 0, 0, 0, 0};
*/
/**
