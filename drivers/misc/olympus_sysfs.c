			...
			char *buf)
{
	...
	else if (strcmp(attr->attr.name, "refresh_rate") == 0)
		var = dsi_obj->refresh_rate;
...
static struct dsi_attribute refresh_attribute =
	__ATTR(refresh_rate, 0666, dsi_show, dsi_store);
