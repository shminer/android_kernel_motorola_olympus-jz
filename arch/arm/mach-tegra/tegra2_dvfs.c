...
//	{900, 950, 1000, 1050, 1100, 1150, 1200}; //altered
	{950,1050,1150,1230,1250,1300,1325};
...
static struct dvfs dvfs_init[] = {
	/* Cpu voltages (mV):	   750, 800, 850, 900, 950, 1000,1200  */
	CPU_DVFS("cpu", 0, 0, MHZ, 200, 456, 608, 816, 912, 1000,1200),
	CPU_DVFS("cpu", 0, 1, MHZ, 200, 456, 608, 816, 912, 1000,1200),
	CPU_DVFS("cpu", 0, 2, MHZ, 200, 456, 608, 816, 912, 1000,1200),
	CPU_DVFS("cpu", 0, 3, MHZ, 200, 456, 608, 816, 912, 1000,1200),

	CPU_DVFS("cpu", 1, 0, MHZ, 200, 456, 608, 816, 912, 1000,1200),
	CPU_DVFS("cpu", 1, 1, MHZ, 200, 456, 608, 816, 912, 1000,1200),
	CPU_DVFS("cpu", 1, 2, MHZ, 200, 456, 608, 816, 912, 1000,1200),
	CPU_DVFS("cpu", 1, 3, MHZ, 200, 456, 608, 816, 912, 1000,1200),

	CPU_DVFS("cpu", 2, 0, MHZ, 200, 456, 608, 816, 912, 1000,1200),
	CPU_DVFS("cpu", 2, 1, MHZ, 200, 456, 608, 816, 912, 1000,1200),
	CPU_DVFS("cpu", 2, 2, MHZ, 200, 456, 608, 816, 912, 1000,1200),
	CPU_DVFS("cpu", 2, 3, MHZ, 200, 456, 608, 816, 912, 1000,1200),

	/* Core voltages (mV) altered:   900,    950,    1000,   1100,   1200,   1250,   1350 */
	CORE_DVFS("emc",     -1, 1, KHZ, 47500,  57000,  333000, 333000, 380000, 600000, 800000),
	...
	CORE_DVFS("2d",      -1, 1, KHZ, 133000, 171000, 247000, 300000, 300000, 400000, 600000),

   // CORE_DVFS("3d",       1, 1, KHZ, 161500, 209000, 285000, 333500, 333500, 361000, 361000),
	CORE_DVFS("3d",       0, 1, KHZ, 218500, 256500, 323000, 380000, 380000, 400000, 600000),
	CORE_DVFS("3d",       1, 1, KHZ, 218500, 256500, 323000, 380000, 380000, 400000, 600000),
	CORE_DVFS("3d",       2, 1, KHZ, 218500, 256500, 323000, 380000, 380000, 400000, 600000),
	CORE_DVFS("3d",       3, 1, KHZ, 218500, 256500, 323000, 380000, 380000, 400000, 600000),
  ...
  //  CORE_DVFS("sclk",     1, 1, KHZ, 123500, 159500, 207000, 240000, 240000, 264000, 277500),
	CORE_DVFS("sclk",     0, 1, KHZ, 152000, 180500, 229500, 260000, 260000, 285000, 333000),
	CORE_DVFS("sclk",     1, 1, KHZ, 152000, 180500, 229500, 260000, 260000, 285000, 333000),
	CORE_DVFS("sclk",     2, 1, KHZ, 152000, 180500, 229500, 260000, 260000, 285000, 333000),
	CORE_DVFS("sclk",     3, 1, KHZ, 152000, 180500, 229500, 260000, 260000, 285000, 333000),
