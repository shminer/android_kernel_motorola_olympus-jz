...
//	{900, 950, 1000, 1050, 1100, 1150, 1200}; //altered
	{900,950,1000,1075,1125,1260,1320};
static const int cpu_millivolts[MAX_DVFS_FREQS] =
//	 200, 456, 608, 816, 912, 1000,1200,1300mhz
	{750, 780, 800, 850, 950, 1000,1130,1250};
...
static struct dvfs dvfs_init[] = {
	...
	CORE_DVFS("emc",     -1, 1, KHZ, 47500,  57000,  333000, 333000, 333000, 600000, 600000),
#if 0
...
#endif
	CORE_DVFS("sdmmc1",  -1, 1, KHZ, 44000,  52000,  52000,  52000,  52000,  52000, 54000),
	CORE_DVFS("sdmmc2",  -1, 1, KHZ, 44000,  52000,  52000,  52000,  52000,  52000, 54000),
	CORE_DVFS("sdmmc3",  -1, 1, KHZ, 44000,  52000,  52000,  52000,  52000,  52000, 54000),
	CORE_DVFS("sdmmc4",  -1, 1, KHZ, 44000,  52000,  52000,  52000,  52000,  52000, 54000),
	...
	CORE_DVFS("epp",     -1, 1, KHZ, 133000, 171000, 247000, 300000, 300000, 300000,400000),
	CORE_DVFS("2d",      -1, 1, KHZ, 133000, 171000, 247000, 300000, 300000, 380000,600000),

   // CORE_DVFS("3d",       1, 1, KHZ, 161500, 209000, 285000, 333500, 333500, 361000, 361000),
	CORE_DVFS("3d",       0, 1, KHZ, 218500, 256500, 323000, 350000, 380000, 380000,600000),
	CORE_DVFS("3d",       1, 1, KHZ, 218500, 256500, 323000, 350000, 380000, 380000,600000),
	CORE_DVFS("3d",       2, 1, KHZ, 218500, 256500, 323000, 350000, 380000, 380000,600000),
	CORE_DVFS("3d",       3, 1, KHZ, 218500, 256500, 323000, 350000, 380000, 380000,600000),

   // CORE_DVFS("mpe",      1, 1, KHZ, 142500, 190000, 275500, 300000, 300000, 300000, 300000),
	CORE_DVFS("mpe",      0, 1, KHZ, 190000, 237500, 300000, 300000, 300000, 300000,400000),
	CORE_DVFS("mpe",      1, 1, KHZ, 190000, 237500, 300000, 300000, 300000, 300000,400000),
	CORE_DVFS("mpe",      2, 1, KHZ, 190000, 237500, 300000, 300000, 300000, 300000,400000),
	CORE_DVFS("mpe",      3, 1, KHZ, 190000, 237500, 300000, 300000, 300000, 300000,400000),
  ...
  //  CORE_DVFS("sclk",     1, 1, KHZ, 123500, 159500, 207000, 240000, 240000, 264000, 277500),
	CORE_DVFS("sclk",     0, 1, KHZ, 152000, 180500, 229500, 260000, 260000, 333000,333000),
	CORE_DVFS("sclk",     1, 1, KHZ, 152000, 180500, 229500, 260000, 260000, 333000,333000),
	CORE_DVFS("sclk",     2, 1, KHZ, 152000, 180500, 229500, 260000, 260000, 333000,333000),
	CORE_DVFS("sclk",     3, 1, KHZ, 152000, 180500, 229500, 260000, 260000, 333000,333000),

   // CORE_DVFS("vde",      1, 1, KHZ, 123500, 152000, 237500, 300000, 300000, 300000, 300000),
	CORE_DVFS("vde",      0, 1, KHZ, 152000, 209000, 285000, 300000, 300000, 300000,400000),
	CORE_DVFS("vde",      1, 1, KHZ, 152000, 209000, 285000, 300000, 300000, 300000,400000),
	CORE_DVFS("vde",      2, 1, KHZ, 152000, 209000, 285000, 300000, 300000, 300000,400000),
	CORE_DVFS("vde",      3, 1, KHZ, 152000, 209000, 285000, 300000, 300000, 300000,400000),
	/* What is this? */
